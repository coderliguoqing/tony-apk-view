...
<!--            <el-table-column prop="createTime" label="创建日期" :formatter="formatDate" sortable>
            ...
            <el-table-column label="操作" width="180">
              <template slot-scope="scope">
                <el-button type="warning"  icon="edit" @click="handleEditType(scope.$index, scope.row)">编辑
                </el-button>
                <el-button type="danger"  icon="delete2" @click="handleDelType(scope.$index, scope.row)">
                  删除
                </el-button>
              </template>
            </el-table-column>
      ...
      reloadDictCache:function(){
          if( this.queryStr.dicttypeId == null ){
            this.$message({
              ...
              baseAjax({
                url: api.sys_dict.type_reload_cache,
                data: JSON.stringify(para),
                success: function (data) {
                  this.addLoading = false;
                  if (data.isSuccess == true) {
