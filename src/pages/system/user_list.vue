  ...
  export default {
    ...
    methods:{
      ...
      showPermissions: function(index, row){
        ...
        baseAjax({
          url: api.sys_auth.user_all_rights,
          data: JSON.stringify(para),
          success: function(data) {
            this.treeLoading = false;
            this.drawUserRightsTree(data.data);
          }.bind(this),
          error: function() {
            this.treeLoading = false;
          }
      ...
      getUserInfoBySso: function(){
        ...
        baseAjax({
          url: api.sys_auth.user_sso_info,
          data: JSON.stringify(para),
          type: 'POST',
          success: function (data) {
            if( data.isSuccess == true ){
              if( data.data != null ){
                this.userForm = {
                  loginName: data.data.staffNum,
                  name: data.data.staffName,
                  password: '',
                  mobile: data.data.tel,
      ...
      getUserAuthList: function( userId ){
        ...
        baseAjax({
          url: api.sys_auth.user_auth_list,
          data: JSON.stringify(para),
          type: 'POST',
          success: function (data) {
            if( data.isSuccess == true ){
      ...
      changeAuthList: function( type ){
        ...
        baseAjax({
          url: api.sys_auth.user_auth_edit,
          data: JSON.stringify(para),
          type: 'POST',
          success: function (data) {
            if( data.isSuccess == true ){
      ...
      submitPassword: function(){
        ...
        baseAjax({
          url: api.sys_auth.user_update_password,
          data: JSON.stringify(para),
          success: function (data) {
            if(data.isSuccess == true ){
              this.editLoading = false;
      ...
      handleDelete: function(index, row){
        this.$confirm('是否确认删除选中的用户?', '提示', {
          ...
          baseAjax({
            url: api.sys_auth.user_delete + row.id,
            data: para,
            type: 'DELETE',
            success: function (data) {
              if( data.isSuccess == true ){
