  ...
  <div>
    ...
    <div id="wrapper">
      <div class="uploader-container">
        ...
        <el-button style="width:78px;height:30px;margin-bottom:10px;float:left;"  :loading="uploadLoading" type="success" @click="start" v-text="startBtn"></el-button>
        <el-button style="width:78px;height:30px;margin-left: 20px;margin-bottom:10px;float:left;" :disabled="stopBtn"  type="danger" @click="stop">暂停上传</el-button>
      </div>
    </div>
    ...
    methods: {
      ...
      wul_init: function() {
        ...
        this.wul_uploader.on('filesQueued', function (files) {
          if( this.fileObject.status === 'ready' ){
            this.$message({
              message: '请先上传文件到服务器',
              type: 'error'
            });
        ...
        this.wul_uploader.on('uploadProgress', function (file, percentage) {
          ...
          // console.log(parseInt(this.fileObject.percentage));
        }.bind(this));
