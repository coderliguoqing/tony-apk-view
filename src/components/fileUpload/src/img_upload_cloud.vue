...
export default {
  ...
  data() {
    return {
      ...
      ifShow: true,
      appId: AppConfig.cloudAppId,
      token: "", //上传凭证
      securityKey: AppConfig.cloudSecurityKey,
      checkUrl: AppConfig.cloudCheckUrl,
      uploadUrl: AppConfig.cloudUploadUrl,
      mergeUrl: AppConfig.cloudMergeUrl,
  ...
  methods: {
    ...
    requestToken: function(paramsJsonStr) {
      var tokenValue = '';
      baseAjax({
        url: api.sys_common.createCloudUploadToken,
        data: JSON.stringify({
