<template>
  <div class="menuTree">
    <el-button size="small" type="primary" icon="fa-refresh" @click="getMenuTreeList">
      重新加载
    </el-button>
    <el-button size="small" type="primary" icon="plus" style="margin-bottom:15px;" @click="handleAdd">
      新建顶级菜单
    </el-button>
    <el-table
      :data="data"
